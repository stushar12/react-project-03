    ...
    <>
      <div className="bg-black w-screen h-screen flex justify-between items-center">
        <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3  bg-gray-800 text-orange-500">
          ...
          <div className="flex shadow border-2 border-white border-l-2 rounded-lg overflow-hidden mb-4">
            <input
              type="text"
              value={password}
          ...
          <div className="flex text-sm gap-x-2">
            ...
            <div className="flex items-center gap-x-1">
              <input
                type="checkbox"
                defaultChecked={charactersIncluded}
                id="characterInput"
                onChange={() => {
